        ...
        <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
          <div className="container mx-auto flex h-16 items-center px-4">
            <Link href="/" className="flex items-center space-x-2 mr-8">
              <span className="text-4xl font-bold bg-gradient-to-r from-[#F63049] to-[#8A244B] bg-clip-text text-transparent">
                MIKI XIX
              </span>
            </Link>
            
            <nav className="flex flex-1 items-center space-x-4 text-sm font-medium text-slate-600">
              <Link href="/" className="hover:text-slate-900 transition-colors font-bold text-lg">
                หน้าหลัก
              </Link>
              <Separator orientation="vertical" className="h-4" /> {/* เส้นคั่นแนวตั้ง */}
              <Link href="/about" className="hover:text-slate-900 transition-colors font-bold text-lg">
                เกี่ยวกับเรา
              </Link>
              <Separator orientation="vertical" className="h-4" />
              <Link href="/products" className="hover:text-slate-900 transition-colors font-bold text-lg">
                สินค้า
              </Link>
            </nav>
          </div>
