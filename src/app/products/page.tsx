    ...
    <main className="container mx-auto px-4 py-8">
      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="text-center py-20 bg-slate-50 rounded-2xl border-2 border-dashed">
            ...
            <Link href="/products" className="text-red-600 hover:underline mt-2 inline-block">ล้างการค้นหา</Link>
        </div>
      ) : (
        <>
            ...
            {filteredProducts.map((product) => (
              ...
              <div key={product.id} className="group flex flex-col border rounded-2xl overflow-hidden hover:shadow-xl transition-shadow duration-300 bg-white">
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <Link href={`/products/${product.id}`} className="hover:text-red-600 transition-colors">
